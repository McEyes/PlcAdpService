...
{
    public class PlcController : AbpController
    {

        IMqttClientService _mqttClient;

        public PlcController(IMqttClientService mqttClient)
        {
        ...
        [SwaggerOperation("Conveyor Start", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor ResetWidth", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor Report", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor Alarm", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor Shutdown", Tags = new string[] { "Conveyor" })]
        ...
        //[SwaggerOperation("Conveyor Get Current Products", Tags = new string[] { "Conveyor" })]
        ...
        //[SwaggerOperation("Conveyor Get Product Parameters", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor Get Machine State", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Conveyor Control Machine", Tags = new string[] { "Conveyor" })]
        ...
        [SwaggerOperation("Equipment Commond", Tags = new string[] { "Equipment" })]
