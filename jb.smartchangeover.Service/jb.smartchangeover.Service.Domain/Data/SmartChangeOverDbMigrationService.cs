...
{
    public class SmartChangeOverDbMigrationService : ITransientDependency
    {
        public ILogger<SmartChangeOverDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ISmartChangeOverDbSchemaMigrator> _dbSchemaMigrators;

        public SmartChangeOverDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ISmartChangeOverDbSchemaMigrator> dbSchemaMigrators)
        {
            _dataSeeder = dataSeeder;
            _dbSchemaMigrators = dbSchemaMigrators;
            Logger = NullLogger<SmartChangeOverDbMigrationService>.Instance;
        }
