...
{
    public class ModbusClient2000 : PlcClient
    {
        ...
        public ModbusClient2000(IEquipmentConfig config, MqttClientService mqttClient, ILogger log = null) : base(config, mqttClient, log)
        {
            ConnPlcMaster();
        }
        ...
        private ushort ToModbusAddress(string address)
        {
            ...
            ushort start = 2000;
            return (ushort)(deviceAddress + start);
        }
